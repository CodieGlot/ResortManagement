    ...
    <header class="bg-white">
      ...
      >
        ...
        <div class="hidden lg:flex lg:gap-x-12">
          <a href="/ResortManagement/Admin/Dashboard/ListEmployee.jsp" class="text-sm font-semibold leading-6 text-gray-900"
            >Management</a
          >
        ...
        <div class="hidden lg:flex lg:flex-1 lg:justify-end">
          <a
            href="/ResortManagement/pages/Auth/login.jsp"
